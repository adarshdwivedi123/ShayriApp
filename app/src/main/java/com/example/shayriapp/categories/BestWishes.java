...
public class BestWishes extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("BestWishes");
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("bestwishes");
        myShayari=new Model();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BestWishes.this, "Error Occurred", Toast.LENGTH_SHORT).show();
            }
        });
