...
public class ValentineDay extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ValentineDay");
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("valentineday");
        myShayari=new Model();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ValentineDay.this, "Error Occurred", Toast.LENGTH_SHORT).show();
            }
        });
