...
public class GOD  extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("GOD");
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("god");
        myShayari=new Model();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(GOD.this, "Error Occurred", Toast.LENGTH_SHORT).show();
            }
        });
