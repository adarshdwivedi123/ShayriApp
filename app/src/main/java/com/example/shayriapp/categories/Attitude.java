...
public class Attitude   extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("attitude");
        myShayari=new Model();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Attitude.this, "Error Occurred", Toast.LENGTH_SHORT).show();
            }
        });
